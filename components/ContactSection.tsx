      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 sm:gap-12">
        <div className="w-full md:w-auto">
           ...
           <a 
             ...
             className="inline-block w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-white text-black font-pixel text-[10px] sm:text-xs hover:bg-cyan-400 transition-colors duration-300 text-center"
           >
             CONTACT US
           </a>
        </div>
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-24 w-full md:w-auto">
          <div>
            ...
            <ul className="space-y-1.5 sm:space-y-2 text-gray-300 font-mono text-xs sm:text-sm">
              <li>Somewhere in the outer space</li>
              <li>(Indore)</li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-1.5 sm:space-y-2 text-gray-300 font-mono text-xs sm:text-sm">
              ...
              <li><a href="https://www.instagram.com/ig_samyakk" className="hover:text-cyan-400 transition-colors">Instagram</a></li>
              <li><a href="https://www.linkedin.com/company/zer0-labs" className="hover:text-cyan-400 transition-colors">LinkedIn</a></li>
            </ul>
          </div>
        </div>
      </div>
