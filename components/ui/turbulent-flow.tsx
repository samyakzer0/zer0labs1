  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        // Black hole themed color palette - Black, Deep Blues, and Cyan
        vec3 color1 = vec3(0.0, 0.0, 0.0); // Pure black (singularity)
        vec3 color2 = vec3(0.0, 0.4, 0.6); // Deep cyan
        vec3 color3 = vec3(0.05, 0.1, 0.2); // Dark blue-black
        vec3 color4 = vec3(0.0, 0.8, 0.95); // Bright cyan (accretion disk)
        vec3 color5 = vec3(0.1, 0.3, 0.5); // Medium blue
